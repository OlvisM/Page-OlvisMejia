const AboutMe = () => {
  return (
    <>
      <article className="">
        <div>
          <h1 className="text-8xl font-semibold">ACERCA DE MÍ</h1>
        </div>
        <div className="flex w-300">
          <div className="w-200">
            <p className="text-justify ">
              ...
              semestres de mi formación academica.
            </p>
          ...
          <section className="flex  text-justify px-10">
            <div className="w-100">
              <div>
                <h1 className="text-3xl font-semibold">EDUCACION </h1>
                <h3 className="mt-3 font-semibold">
                  Instituto Tecnologico de las Americas.
                </h3>
                <p className="">
                  Tecnólogo en desarrollo de software | Actual Estudiante activo
                  de término.
                </p>
              </div>
              <div className="mt-5">
                <h1 className="font-semibold">Politécnico</h1>
                <p> Bachiller | 2020</p>
              </div>
            </div>
          </section>
